...
- Create Angular project with ng: `ng new jitu-dashboard.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`jitu-dashboard.client.esproj`).
